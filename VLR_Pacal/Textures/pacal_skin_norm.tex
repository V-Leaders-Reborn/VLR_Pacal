...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\Pacal\pacal_skin_norm.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3127647696</m_ExportedTime>
	<m_ClassName text="Leader_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="pacal_skin_norm.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="pacal_skin_norm"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>

...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\Pacal\pacal_trans_mask.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3298108715</m_ExportedTime>
	<m_ClassName text="Leader_OPAC"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="pacal_trans_mask.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="pacal_trans_mask"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>

...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Civ5_Leaders_Reborn\Texture_Source\Pacal\pacal_skin_blur_up.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3985308780</m_ExportedTime>
	<m_ClassName text="Leader_BlurWidth"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="pacal_skin_blur_up.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="pacal_skin_blur_up"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
